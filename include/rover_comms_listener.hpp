...
class RoverCommsListener : public cave_talk::ListenerCallbacks
{
    public:
        ...
        void HearAirQuality(const uint32_t dust_ug_per_m3, const uint32_t gas_ppm) override;
        // void HearAirQuality(const uint32_t dust_ug_per_m3, const uint32_t gas_ppm, const double temperature_celsius) override;
